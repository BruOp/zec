...
static SamplerState default_sampler;
...
{
    Texture2D albedo_texture = ResourceDescriptorHeap[albedo_texture_idx];
    Texture2D normal_texture = ResourceDescriptorHeap[normal_texture_idx];
    ...
    default_sampler = SamplerDescriptorHeap[SamplersIndices::ANISOTROPIC_WRAP];
