...
RWTexture2D<half2> rw_tex2D_table[4096] : register(u0, space1);
...
{
    RWTexture2D<half2> out_texture = rw_tex2D_table[out_texture_idx];
    float2 dims;
    ...
    out_texture[dispatch_id.xy] = half2(res.xy);
}
