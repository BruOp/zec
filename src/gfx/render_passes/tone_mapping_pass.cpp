...
namespace zec
{
    ...
    static constexpr SettingsDesc settings[] = {
        ...
        RenderPassSharedSettings::exposure,
    };
    ...
    static void tone_mapping_pass_exectution(const RenderPassContext* context)
    {
        ...
        const float exposure = context->settings->get_settings<float>(RenderPassSharedSettings::exposure.identifier);
        ...
        const MeshHandle fullscreen_mesh = context->settings->get_settings<MeshHandle>(RenderPassSharedSettings::fullscreen_quad.identifier);
